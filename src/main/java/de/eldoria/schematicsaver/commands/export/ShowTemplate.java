...
public class ShowTemplate extends AdvancedCommand implements IPlayerTabExecutor {
    ...
    public ShowTemplate(Plugin plugin, BoundingRenderer boundingRenderer, Configuration configuration) {
    ...
    public @Nullable List<String> onTabComplete(@NotNull Player player, @NotNull String alias, @NotNull Arguments args) throws CommandException {
        return switch (args.size()) {
            case 1 -> TabCompleteUtil.complete(args.asString(0), configuration.templateRegistry().templateNames());
